#include    "booga.h"
/*
 * booga.c -- the expansion of the given driver code
 * This project integrates semaphores to prevent race condition
 */
...
static int booga_open (struct inode *inode, struct file *filp)
{
	...
	//Update semaphore to avoid race condition
    up(&booga_device -> sem);
